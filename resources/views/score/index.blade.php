                            ...
                            <table class="table table-bordered dt-responsive  nowrap w-100 " id="datatable" >
                                ...
                                @foreach($data as $val)
                                    <tr data-id="{{ $val->id }}">
                                        ...
                                        <td data-field="score">{{ $val->score }}</td>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open(['route' => ['score.destroy', $val],'method' => 'delete',  'class'=>'d-inline-block dform']) !!}
                                        ...
                                        <div id="designation_edit{{ $val->id }}" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
                                              <div class="modal-dialog" role="document">
                                                {!! Form::model($val, ['method' => 'PATCH','route' => ['score.update', $val->id]]) !!}
                                                @csrf
                                                <div class="modal-content">
                                                  <div class="modal-header">
