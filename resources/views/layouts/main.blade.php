                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{url('home')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('kusumgar/kusumgar/kusumgar_269_86_logo_t_png.png') }}" alt="" class="img-fluid">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('kusumgar/kusumgar/kusumgar_269_86_logo_t_png.png') }}" alt="" class="img-fluid">
                                </span>
                        ...
                        <div class="dropdown dropdown-mega d-none d-lg-block ms-2" style="margin-top: 8px;">
                             @role('SuperAdmin')
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('application*')) active-menu @endif" onclick='window.location.href = "{{url('application')}}"'>
                                        <i class="bx bx-home-circle"></i>
                                        <span key="t-dashboards">Application</span>
                                </button>
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('plant*')) active-menu @endif" onclick='window.location.href = "{{url('plant')}}"'>
                                        <i class="bx bx-home-circle"></i>
                                        <span key="t-dashboards">Plant</span>
                                </button>
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('department*')) active-menu @endif" onclick='window.location.href = "{{url('department')}}"'>
                                        <i class="bx bx-home-circle"></i>
                                        <span key="t-dashboards">Department</span>
                                </button>
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('type*')) active-menu @endif" onclick='window.location.href = "{{url('type')}}"'>
                                        <i class="bx bx-home-circle"></i>
                                        <span key="t-dashboards">Type</span>
                                </button>
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('users*')) active-menu @endif" onclick='window.location.href = "{{url('users')}}"'>
                                        <i class="bx bx-home-circle"></i>
                                        <span key="t-dashboards">Users</span>
                                </button>
                                <button type="button" class="btn header-item waves-effect @if (request()->routeIs('score*')) active-menu @endif" onclick='window.location.href = "{{url('score')}}"'>
                                        <i class="bx bx-home-circle"></i>
                            ...
                            @else
                            <button type="button" class="btn header-item waves-effect @if (request()->routeIs('home*')) active-menu @endif" onclick="window.location.href = '{{ route("home") }}';" href="">
                                <i class="bx bx-home-circle"></i>
                                Dashboard
                            </button>
                            @endrole
                            <button type="button" class="btn header-item waves-effect @if (request()->routeIs('suggestion*')) active-menu @endif" onclick="window.location.href = '{{ route("suggestion.index") }}';">
                                <!-- <i class="bx bx-home-circle"></i> -->
                                Data
                            </button>
                            @endrole
